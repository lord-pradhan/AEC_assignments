...
/* virtual */ void FsLazyWindowApplication::Initialize(int argc,char *argv[])
{
	if(argc==7)
	{
		MakeNACA4DigitAirfoilWing( mesh, strtol(argv[1], nullptr, 10) , stof(argv[2], nullptr), 
			stof(argv[3], nullptr), stof(argv[4], nullptr), stof( argv[5], nullptr) , 
			stof(argv[6], nullptr) );
	...
	else if(2<=argc && true==mesh.LoadBinStl(argv[1]))
	{
		RemakeVertexArray();
		mesh.GetBoundingBox(bbx[0],bbx[1]);
		...
		printf("the inputs aren't correct, please check\n");
